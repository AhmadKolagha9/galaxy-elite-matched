  ...
  return (
    <>
      ...
      <div className="dashboard-hero" style={{ marginTop: 22 }}>
        ...
        <div className="hero-actions"><Link className="button button-gold" href="/submit">Submit</Link><Link className="button button-outline" href="/private-opportunities?mode=investor">Private Opportunities</Link>{isAdminUser(user) ? <Link className="button button-dark" href="/admin">Control Dashboard</Link> : null}</div>
      </div>
