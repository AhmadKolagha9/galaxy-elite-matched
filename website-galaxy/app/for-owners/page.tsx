    ...
    <>
      ...
      <section className="section split">
        <div>
          ...
          <div className="hero-actions"><Link className="button button-gold" href="/private-availability">Submit Private Availability</Link><Link className="button button-outline" href="/interest-board">View Interest Board</Link></div>
        </div>
