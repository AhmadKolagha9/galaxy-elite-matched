  ...
  return (
    <form className="premium-form" onSubmit={onSubmit}>
      ...
      <div className="document-upload-panel">
        ...
        <p>Upload available documents for review. Document metadata is stored in MySQL; production document files should use secure private cloud storage with signed URLs and access logs.</p>
