...
import { interestMatchRequestsRouter } from "./interest-match-requests.js";
import { matchRoomsRouter } from "./match-rooms.js";
import { matchesRouter } from "./matches.js";
import { newProjectsRouter } from "./new-projects.js";
...
apiRouter.use("/new-projects", newProjectsRouter);
apiRouter.use("/matches", optionalAuth, matchesRouter);
apiRouter.use("/interest-match-requests", optionalAuth, interestMatchRequestsRouter);
